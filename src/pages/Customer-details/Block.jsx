...
import { useGetBlockByNameQuery } from "../Redux/ReduxApi";
...
const Block = () => {
  ...
  const { data: customer, isFetching } = useGetBlockByNameQuery({
    search: "",
    pages,
    pageSize,
  });
  ...
  const restdata = customer?.result;
