...
const TurnOver = () => {
  ...
  const { data: maximum, refetch: outsidefetch } =
  useGetCallMaxiumByNameQuery({
      position: 0,
      restId,
      parentId,
  ...
  const maximumData = maximum?.data;
  ...
  const tableData1 = maximumData?.map((item, index) => [
    index + 1,
    // moment(item.crDate).format("L"),
    // `${item.roundTime1.hours}:${item.roundTime1.minutes}`,
    // `${item.roundTime2.hours}:${item.roundTime2.minutes}`,
            ...
            <Tables
              ...
              columns={[
                ...
                },
                {
                  ...
                  render: (Breakfast) => (
                    <div>
                      {convertSecondsToMinutes(Breakfast ? Math.ceil(Breakfast) : 0)}
                    </div>
                  ),
                },
                {
                  ...
                  render: (Lunch) => (
                    <div>
                      {convertSecondsToMinutes(Lunch ? Math.ceil(Lunch) : 0)}
                    </div>
                  ),
                },
                {
                  ...
                  render: (Dinner) => (
                    <div>
                      {convertSecondsToMinutes(Dinner ? Math.ceil(Dinner) : 0)}
                    </div>
                  ),
                },
              ]}
